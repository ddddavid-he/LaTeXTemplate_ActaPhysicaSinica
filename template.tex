...
\author[
    David He\superscript{1)\dagger} \and Jackman He\superscript{2)} \and Cooper Guo\superscript{3)} \and John He\superscript{4)} \and Orange Guo\superscript{4)}
]{
    大维\superscript{1)\dagger} \and 杰汉\superscript{2)} \and 橙子\superscript{3)} \and 君君\superscript{1)} \and 橘子\superscript{4)}
}
\institude[
    ...
    4) Institude of Zhonger, Chinese Academy of Science, Beijing China
]{
    1)双鸭山大学\ 物理学院，广州 
...
\begin{multicols}{2}
    ...
    标题排列和编号方式为附录A，附录B，附录C。


    \appendix

    每个附录里如果有表，则相应为表A1,A2，表B1,B2，表C1,C2。
